...
@app.route("/elbow.html")
def dashboard_template():
	return render_template("elbow.html")

@app.route("/topLoadingsStratified.html")
def user():
	return render_template("topLoadingsStratified.html")

@app.route("/parallel_axes.html")
def parallel():
	return render_template("parallel_axes.html")

@app.route("/PcaStrat.html")
def pcastrat():
	return render_template("PcaStrat.html")

@app.route("/MdsStrat.html")
def mdsstrat():
	return render_template("MdsStrat.html")

@app.route("/stackedBar.html")
def stackedbar():
	return render_template("stackedBar.html")

@app.route("/brushMonth.html")
def brushMonth():
	return render_template("brushMonth.html")

@app.route("/sunBurst.html")
def sunBurst():
	return render_template("sunBurst.html")

# @app.route("/table_template")e
